...
interface Props extends Omit<DetailedHTMLProps<
ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement>, 'type'
> {
  size?: Size;
  children?: ReactNode;
...
const VARIANT_STYLE = {
  ...
  contained: 'border-none text-white bg-blue-500',
  outlined: clsx(
